      ...
      *> ------------------------------------------------------
       ...
       FILE-CONTROL.
           ...
           "C:\Users\34636\Documents\COBOL-Crear-archivos\REPORTE.txt".
       ...
       040-SELECCIONA.
           *>IF WS-DEPTO-EMP EQUAL 8
              *>THEN
                 RELEASE REG-SORT FROM WS-REG-EMPLEADOS *> No es ni un read ni un write, sino una forma de enviar datos al programa de ordenación.
